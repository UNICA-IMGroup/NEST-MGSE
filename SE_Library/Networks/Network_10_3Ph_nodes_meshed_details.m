function Network = Network_10_3Ph_nodes_meshed_details()
%%
%Network Topology
...
Network.branches.From = [1, 2, 3, 2, 2, 6, 7, 6, 7, 5]';
Network.branches.To   = [2, 3, 4, 5, 6, 7, 8, 9, 10, 9]';

%%
%Network Parameters
%branch length in miles
Network.branches.branch_length = [2000, 500, 300, 500, 2000, 300, 300, 500, 800, 1000]/5280; % miles (5280 feet per mile)
...
Network.branches.branch_config = [601, 603, 603, 602, 601, 604, 605, 606, 607, 602]';
