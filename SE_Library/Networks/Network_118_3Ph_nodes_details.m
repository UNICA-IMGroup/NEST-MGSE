...
function Network = Network_118_3Ph_nodes_details()
%%
%Network Topology
...
Network.branches.From = [1, 2, 2, 4, 4, 6, 2, 8, 9, 9, 11, 12, 12, 9, 15, 16, 17, 17, 15, 20, 21, 20, 23, 23, 25, 25, 27, 28, 29, 28, 31, 27, 33, 34, 35, 20, ...
                ...
                102, 99, 104, 105, 106, 104, 108, 109, 108, 111, 111, 113, 114, 114, 116, 117]';
Network.branches.To = (2 : Network.nodes.num_nodes)'; 
...
Network.branches.branch_length = [400, 175, 250, 200, 325, 250, 300, 200, 225, 225, 425, 250, 250, 300, 150, 100, 350, 375, 825, 250, 325, 300, 525, 250, 550, 275, ...
                 ...
                 100, 225, 475, 475, 250, 250, 675, 475, 700, 450, 175, 275, 225, 225, 300, 225, 275, 300, 200, 250, 275, 550, 300, 800, 250, 225, ...
                 325, 700, 275, 225, 575, 325, 1000, 450, 300, 575, 125, 525, 325]/5280; % miles (5280 feet per mile)
...
Network.branches.branch_config = [1, 10, 11, 11, 11, 11, 1, 1, 10, 9, 9, 9, 9, 1, 11, 11, 11, 11, 2, 9, 9, 2, 10, 2, 11, 2, 7, 11, 11, 9, 9, 2, 2, 2, 2, 4, 8, 9, 10, ...
                 ...
                 9, 6, 7, 7, 11, 11, 11, 3, 6, 9, 6, 10, 6, 11, 8, 9, 10, 10, 3, 3, 3, 3, 3, 3, 11, 11, 11, 3, 10, 10, 3, 3, 9, 9, 9, 9, 9, 9]';
...
%Active Power
PA = [40, 0, 0, 0, 0, 0, 20, 0, 0, 40, 0, 20.12, 40.45, 0, 0, 0, 0, 0, 0, 40, 39.87, 0, 0, 0, 0, 0, 0, 0, 0, 0, 39.81, 39.87, 39.73, 0, 20, 40, 0, 39.55, 0, 0, 0, 0, 20, 0, 0, 19.83, 20, ...
