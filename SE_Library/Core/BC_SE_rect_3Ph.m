function [Vr, Vx, Ir, Ix, num_iter] = BC_SE_rect_3Ph(num_nodes, num_branches, nominal_linedata, node_3ph, node_3ph_reverse, V_abs, V_theta, zdata, Znod, Znod_state, Gzcomplex, Gz, Gz_state)
...
Ir = I_abs.*cos(I_theta);
Ix = I_abs.*sin(I_theta);
...
[Vr, Vx, Ir, Ix, num_iter] = BC_DSSE_rectangular_traditional_3Ph(num_nodes, nominal_linedata, node_3ph, node_3ph_reverse, V_abs, V_theta, Ir, Ix, zdata, Znod_state, Gz);
