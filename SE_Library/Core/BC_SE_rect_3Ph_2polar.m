function [V, I, num_iter] = BC_SE_rect_3Ph_2polar(num_nodes, num_branches, nominal_linedata, node_3ph, node_3ph_reverse, V_abs, V_theta, zdata, Znod, Znod_state, Gzcomplex, Gz, Gz_state)
...
[V, I, num_iter] = BC_DSSE_rect_trad_3Ph_2polar(num_nodes, nominal_linedata, node_3ph, node_3ph_reverse, V_abs, V_theta, Ir, Ix, zdata, Znod_state, Gz);
