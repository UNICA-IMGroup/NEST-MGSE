...
Stranting from the Network under monitoring description, the measurement system description, and the measurements (pseudo-measurements and real time measurements), the software provides the estimates of all the node Voltages and of all the branch currents, in module and phase angle, along with their extended uncertainty.  
