function h = PlotNetwork_to_SE(nominal_linedata_t, meas_indices)
    ...
    h = plotNetwork(nominal_linedata_t.branch_first, nominal_linedata_t.branch_end, nominal_linedata_t.branch_cod, monitoredNodes, monitoredBranches);    